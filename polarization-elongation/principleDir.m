...
maskToRegion::usage = "given a mask the function outputs the shortest path along the perimeter and mesh region defined by the path";
findSym::usage = "findSym[mask_,option_:False] takes in a mask and outputs the center of mass and the eigenvectors defining the pseudo-axis of symmetry.
Graphic displayed with option set to True."
bisectMask::usage = "bisectMask[mask_,option_:False] the function takes in a mask and outputs both the centroid of the image plus the intersections of the
pseudo-axis of symmetry on the boundary. Graphic with option set to True."
...
\[ScriptCapitalR]2=InfiniteLine[{centerofMass,centerofMass+v1}];
