...
maskToRegion::usage = "given a mask, maskToRegion[mask_] outputs an ordered list of pixels of the mask boundary as well as converts the mask to a region.";
findSym::usage = "findSym[mask_,option_:False] takes in a mask and outputs the principle directions for the mask as {centroid, boundarypt1, boundarypt2}.
